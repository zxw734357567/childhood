...
import com.zxw.childhood.passport.common.cookie.DefaultCookieOperations;
import com.zxw.childhood.passport.common.cookie.PassportCookieServices;
import com.zxw.childhood.passport.common.filter.PassportClientAuthProcessingFilter;
import com.zxw.childhood.passport.common.filter.PassportCookieAuthenticationFilter;
import com.zxw.childhood.passport.common.handler.ClientAuthenticationSuccessHandler;
import com.zxw.childhood.passport.common.handler.ClientLoginUrlAuthenticationEntryPoint;
import com.zxw.childhood.passport.common.handler.ClientLogoutSuccessHandler;
import com.zxw.childhood.passport.common.permission.AccessPermission;
...
public class PassportSsoSecurityConfigurer {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(new PassportClientAuthConfigurer(authFilter(sso),ssoFilter(sso)));//在OAuth2ClientAuthenticationProcessingFilter中cookieFilter之前,在之后是ssoFIlter
